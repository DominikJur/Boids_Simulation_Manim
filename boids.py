...
if __name__ == "__main__":
    # Default boids
    boids1 = Boids2D(n=30, size=100)
    
    # Tighter flocks (smaller radii, stronger cohesion)
    boids2 = Boids2D(
        n=30, size=100,
    ...
    # Faster, more chaotic (higher speeds, weaker alignment)
    boids3 = Boids2D(
        n=30, size=100,
        max_speed=4.0,
        max_force=0.2,
    ...
    # Very spread out (large radii, weak separation)
    boids4 = Boids2D(
        n=30, size=100,
